...
namespace bp.ot.s.API.Entities.Dane.Invoice
{
    public partial class InvoiceService
    {
        ...
        public InvoiceBuyListDTO EtoDTOInvoiceBuyList(InvoiceBuyDTO dto)
        {
            ...
            res.DataSprzedazy = Pomocne.DateHelp.DateHelpful.FormatDateToYYYYMMDD(dto.DateOfSell);
        ...
        private InvoiceSellListDTO EtoDTOInvoiceSellList(InvoiceSellDTO dto)
        {
            ...
            res.Brutto = dto.InvoiceTotal.Current.Total_brutto;
            res.DataSprzedazy = bp.Pomocne.DateHelp.DateHelpful.FormatDateToYYYYMMDD(dto.DateOfSell);
            res.DocumentNo = dto.InvoiceNo;
        ...
        public async Task<Jpk> GetJpk(DateRangeDTO dateRange)
        {
            ...
            foreach (var sPos in sprzedaz)
            {
                ...
                wiersz.NrKontrahenta = bp.Pomocne.StringHelp.StringHelpful.Nip10LastChars(sPos.CompanyBuyer.Vat_id);
        ...
        public StringBuilder JpkToStringBuilder(Jpk jpk)
        {
            var dateClassicFormat = bp.Pomocne.DateHelp.DateHelpful.DateFormatClassic();
            var dateTimeClassicFormat = bp.Pomocne.DateHelp.DateHelpful.DateTimeFormatClassic();
