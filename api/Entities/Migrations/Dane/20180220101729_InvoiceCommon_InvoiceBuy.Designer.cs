...
namespace bp.ot.s.API.Entities.Migrations.Dane
{
    ...
    [Migration("20180220101729_InvoiceCommon_InvoiceBuy")]
    partial class InvoiceCommon_InvoiceBuy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bp.ot.s.API.Entities.Dane.Invoice.InvoiceBuy", b =>
                {
                    ...
                    b.Property<DateTime?>("InvoiceReciveDate");
            ...
            modelBuilder.Entity("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfoChecked", b =>
                {
            ...
            modelBuilder.Entity("bp.ot.s.API.Entities.Dane.Invoice.InvoiceBuy", b =>
                {
                    b.HasOne("bp.ot.s.API.Entities.Dane.Company.Company", "CompanySeller")
            ...
            modelBuilder.Entity("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfoChecked", b =>
                {
                    b.HasOne("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfo", "CmrChecked")
                        .WithOne("Cmr")
                        .HasForeignKey("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfoChecked", "CmrCheckedId");

                    b.HasOne("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfo", "RecivedChecked")
                        .WithOne("Recived")
                        .HasForeignKey("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfoChecked", "RecivedCheckedId");

                    b.HasOne("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfo", "SentChecked")
                        .WithOne("Sent")
                        .HasForeignKey("bp.ot.s.API.Entities.Dane.Invoice.InvoiceExtraInfoChecked", "SentCheckedId");
                });
